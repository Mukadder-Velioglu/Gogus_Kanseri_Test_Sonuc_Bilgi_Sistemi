	...
	<div class="d-flex justify-content-center h-100">
		<div class="card">
			<div class="card-header">
				<center><h4>DOKTOR</h4></center>
			</div>
			<div class="card-body">

			<form action="doktorgiris_isle.php" method="POST">
				  ...
				  <div class="form-check">
					...
					<br>
					<br>
					<center><button type="submit" align="center" name="doktor_giris" id="giris" class="btn">Giriş</button></center>
					<br>
					<br>
				</form>
